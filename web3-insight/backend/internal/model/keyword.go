...
type Keyword struct {
	...
	Keyword   string     `gorm:"type:varchar(255);not null;uniqueIndex:idx_keyword_theme" json:"keyword"`
	...
	ThemeID   string     `gorm:"type:varchar(50);uniqueIndex:idx_keyword_theme" json:"themeId"`
